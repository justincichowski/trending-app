...
export const TRENDING_TTL_MS = Number(process.env.TRENDING_TTL_MS ?? String(15 * 60 * 1000)); // right column (ms)
...
export const TRENDING_TTL_S = Math.floor(TRENDING_TTL_MS / 1000); // derived (s)
