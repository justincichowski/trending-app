...
export function getCategories() {
    return get(`${API_BASE_URL}/presets`);
}
/**
 ...
 */
export function getAllItems(page = 0, excludedIds = [], limit) {
 ...
 * @returns {Promise<NormalizedItem[]>} A promise that resolves to an array of normalized items.
 */
export function getCategoryItems(id, page = 0, limit, excludedIds = [], query) {
...
export function getTopTrends() {
    return get(`${API_BASE_URL}/toptrends`);
}
/**
...
export function getTrending() {
    return get(`${API_BASE_URL}/trending`);
}
